	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		r.Route("/organization", func(r chi.Router) {
			...
			r.Group(func(r chi.Router) {
				...
				r.Get("/list-organization-policy", svc.listOrgPolicyOrg_iamHandler)
				r.Get("/get-organization-policy", svc.getOrgPolicyOrg_iamHandler)
				r.Get("/list-organization-user-reserved", svc.listOrgUserReservedOrg_iamHandler)
				r.Get("/list-organization-access-token", svc.listOrgAccessTokenOrg_iamHandler)
				r.Group(func(r chi.Router) {
					r.Use(middleware.AllowContentType(contenTypeJSON))
					...
					r.Post("/put-organization-role", svc.putOrgRoleOrg_iamHandler)
					r.Post("/put-organization-policy", svc.putOrgPolicyOrg_iamHandler)
					r.Post("/attach-organization-role", svc.attachOrgRoleOrg_iamHandler)
					r.Post("/attach-organization-policy", svc.attachOrgPolicyOrg_iamHandler)
					r.Post("/detach-organization-role", svc.detachOrgRoleOrg_iamHandler)
					r.Post("/detach-organization-policy", svc.detachOrgPolicyOrg_iamHandler)
					r.Post("/delete-organization-role", svc.deleteOrgRoleOrg_iamHandler)
					r.Post("/delete-organization-policy", svc.deleteOrgPolicyOrg_iamHandler)
					r.Post("/delete-organization-user-reserved", svc.deleteOrgUserReservedOrg_iamHandler)
					r.Post("/put-organization-user-reserved", svc.putOrgUserReservedOrg_iamHandler)
					r.Post("/generate-organization-access-token", svc.generateOrgAccessTokenOrg_iamHandler)
					r.Post("/update-organization-access-token", svc.updateOrgAccessTokenOrg_iamHandler)
					r.Post("/delete-organization-access-token", svc.deleteOrgAccessTokenOrg_iamHandler)
					r.Post("/attach-organization-access-token-role", svc.attachOrgAccessTokenRoleOrg_iamHandler)
					r.Post("/detach-organization-access-token-role", svc.detachOrgAccessTokenRoleOrg_iamHandler)
				})
			})
		})
