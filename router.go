		...
		r.Route("/code", func(r chi.Router) {
			...
			r.Group(func(r chi.Router) {
				...
				r.Group(func(r chi.Router) {
					...
					r.Post("/put-dependency-setting", svc.putDependencySettingHandler)
					r.Post("/delete-dependency-setting", svc.deleteDependencySettingHandler)
					r.Post("/invoke-scan-gitleaks", svc.invokeScanGitleaksHandler)
					r.Post("/invoke-scan-dependency", svc.invokeScanDependencyHandler)
				})
			})
		})
