...
func TestListGCPHandler(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:       "OK",
			input:      `project_id=1&google_data_source_id=1&gcp_id=1`,
			mockResp:   &google.ListGCPResponse{},
			wantStatus: http.StatusOK,
		},
		{
...
func TestPutGCPHandler(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:       "OK",
			input:      `{"project_id":1, "gcp": {"gcp_id":1, "google_data_source_id":1, "name":"test", "project_id":1, "gcp_project_id":"my-pj"}}`,
			mockResp:   &google.PutGCPResponse{},
			wantStatus: http.StatusOK,
		},
		{
